      ...
      <InnerLayout>
        ...
        <div className="resume-container">
          ...
          <ResumeItem
            title={'Back-end'}
            text={
              'MVC, Firebase, GraphQL, JWT, Cookie Parser, Socket.io, AWS-EC2, Integración-Checkout PayPal, Integración-Checkout Pro de Mercado Pago, Postman.'
            }
          />
          <ResumeItem
        ...
        <div className="resume-container education-container">
          <ResumeItem
            ...
            text={'Egresado de la Universidad Católica San Pablo, Arequipa(Perú)'}
          />
          <ResumeItem
            year={'2021'}
            title={'Coding Dojo Bootcamp'}
            text={
              'Certificado como cinturón negro (rango más alto) en el desarrollo de fullstack MERN.'
            }
          />
        </div>
        <MenuItemStyled>
          <div className="grid-item">
            <div className="portfolio-content">
              <div className="portfolio-image">
                ...
                <ul>
                  <li>
                    <a href="https://drive.google.com/drive/folders/1h2LxySMzfFseUP1r2EsjL0rALs4LxXPe">
                      <DownloadIcon />
                    </a>
                  </li>
                </ul>
              ...
              <p>
                Graduado de Bootcamp Coding Dojo con el rango de Cinturón negro
                en MERN.
              </p>
            </div>
          </div>
        ...
        <MenuItemStyled>
          <div className="grid-item">
            <div className="portfolio-content">
              ...
              <p>
                Integración del Checkout Pro de Mercado Pago (pasarela de pagos)
                y miembro del dev program de Mercado Libre.
              </p>
            </div>
          </div>
        </MenuItemStyled>
